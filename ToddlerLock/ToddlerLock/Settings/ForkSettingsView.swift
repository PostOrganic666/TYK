...
private extension PlayModeType {
    var detail: String {
        ...
        case .animals: return "Шесть рисованных животных появляются по одному. Голос спокойно произносит название, без очков, таймеров и конфетти."
        case .transport: return "Шесть видов транспорта в том же книжном стиле. Каждое нажатие меняет объект и называет его."
